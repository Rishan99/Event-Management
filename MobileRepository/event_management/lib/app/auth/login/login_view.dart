...
class LoginView extends StatelessWidget {
  ...
  LoginView({super.key, required this.authenticationViewModel});
                    ...
                    onPressed: () async {
                      ...
                      if (formKey.currentState!.validate()) {
                        ...
                        try {
                          ...
                          await pr.hide();
                          Navigator.of(context).pushNamedAndRemoveUntil(Routes.cityPage, (route) => false);
                        } catch (e) {
                          await pr.hide();
                      ...
                      children: [
                        ...
                        TextSpan(
                          recognizer: TapGestureRecognizer()
                            ..onTap = () {
                              FocusScope.of(context).requestFocus(FocusNode());
                              authenticationViewModel.updateAuthenticationState(AuthenticationState.register);
                            },
                          text: 'Register here',
